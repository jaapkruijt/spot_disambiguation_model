...
ak13 = {'gender': ['man', 'meneer'], 'hair_style': 'kaal'}
...
sp20 = {'gender': ['man', 'meneer'], 'hair_style': 'kort haar', 'hair_color': ['donker haar', 'bruin haar'], 'hair_type': 'stekels', 'facial hair': 'baardje'}
